...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const HEAD_RADIUS  = 100

    const bottom = new Image()
    const top    = new Image()
    bottom.src = '/images/one.jpg'
    top.src    = '/images/twoo.jpg'
    ...
    const draw = () => {
      ...
      // cursor head glow — spider-sense red tint
      if (trail.length > 0) {
        const head = trail[0]
        ...
        glow.addColorStop(0,   'rgba(220, 20, 40, 0.28)')
        glow.addColorStop(0.5, 'rgba(220, 20, 40, 0.12)')
      ...
      >
        ...
        <motion.div className="left" variants={item}>
          ...
          <h1 className="st-title"
            ...
            YOUR FRIENDLY<br />NEIGHBOR
          </h1>
          <motion.p className="st-desc" variants={item}
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic' }}>
            He is the web. He is the hope. Born from loss, forged in responsibility —
            New York's silent guardian wears a mask, carries no weapon,
            and fears nothing but the day he stops trying to do what's right.
          </motion.p>
        ...
        <motion.div className="right" variants={item}>
          ...
          <motion.p className="st-text" variants={item}
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic' }}>
            Student by day. Hero by night. Every web a lifeline,
            every rooftop a battlefield. He doesn't do this for glory — but because
